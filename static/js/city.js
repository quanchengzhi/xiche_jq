var cityList = [{
  ...
  {
    key: 'K',
    data: ['克孜勒苏柯尔克孜自治州', '克拉玛依市', '凯里市', '喀什地区', '喀纳斯', '垦利县', '奎屯市', '宽城满族自治县', '岢岚县', '库尔勒市', '库车县', '康乐县', '康保县', '康定县', '康定新都桥', '开化县', '开原市', '开县', '开封市', '开平市', '开远市', '昆山市', '昆明市', '柯坪县']
  },
  {
    key: 'L',
    data: ['临县', '临城县', '临夏回族自治州', '临安市', '临朐县', '临武县', '临江市', '临汾市', '临沂市', '临沧市', '临沭县', '临泉县', '临海市', '临清市', '临湘市', '临漳县', '临澧县', '临猗县', '临西县', '临邑县', '临颍县', '临高县', '丽水市', '丽江市', '乐东黎族自治县', '乐亭县', '乐山市', '乐平市', '乐清市', '乐陵市', '六安市', '六盘水市', '兰州市', '兰溪市', '冷水江市', '凉山彝族自治州', '利川市', '利津县', '卢氏县', '吕梁市', '娄底市', '岚县', '庐山风景区', '廉江市', '廊坊市', '拉萨市', '旅顺口区', '来安县', '来宾市', '林口县', '林州市', '林芝地区', '柳州市', '柳林县', '柳河县', '栾城县', '栾川县', '梁山县', '梁平县', '梁河县', '泸定县', '泸州市', '泸沽湖', '泸溪县', '泸西县', '洛南县', '洛宁县', '洛川县', '洛阳市', '浏阳市', '涞水县', '涞源县', '涟水县', '涟源市', '溧水县', '溧阳市', '滦南县', '滦县', '滦平县', '潞城市', '澧县', '灵宝市', '灵寿县', '灵武市', '灵石县', '理县', '禄丰县', '禄劝彝族苗族自治县', '离石区', '绿春县', '罗山县', '罗平县', '罗江县', '罗源县', '罗田县', '老河口市', '耒阳市', '聊城市', '荔波县', '莱州市', '莱芜市', '莱西市', '莱阳市', '蓝山县', '蠡县', '轮台县', '辽源市', '辽阳市', '连云港市', '连城县', '连江县', '郎溪县', '醴陵市', '阆中市', '陆良县', '陇南市', '陵县', '陵川县', '陵水黎族自治县', '隆化县', '隆回县', '隆尧县', '鲁山县', '鹿泉市', '鹿邑县', '黎城县', '黎平县', '龙井市', '龙南县', '龙口市', '龙山县', '龙岩市', '龙泉市', '龙泉驿区', '龙海市', '龙游县', '龙胜各族自治县', '龙虎山']
  },
  {
    key: 'M',
    data: ['孟州市', '孟村回族自治县', '孟津县', '密山市', '弥勒县', '明光市', '明溪县', '木垒哈萨克自治县', '木渎风景区', '梅州市', '梅河口市', '民权县', '汨罗市', '渑池县', '满城县', '满洲里市', '漠河县', '牡丹江市', '玛纳斯县', '眉山市', '米东区', '米脂县', '绵山风景区', '绵竹市', '绵阳市', '芒市', '芒康县', '苗栗', '茂县', '茂名市', '蒙城县', '蒙自市', '蒙阴县', '闽侯县', '闽清县', '马尔康县', '马祖', '马鞍山市', '马龙县', '麦盖提县', '麻城市', '麻江县', '麻阳苗族自治县']
  },
  {
    key: 'N',
    data: ['内丘县', '内乡县', '内江市', '内黄县', '农安县', '南乐县', '南京市', '南充市', '南华县', '南县', '南召县', '南和县', '南城县', '南宁市', '南安市', '南宫市', '南岳区', '南川区', '南平市', '南康市', '南戴河', '南投', '南昌市', '南浔区', '南漳县', '南皮县', '南通市', '南阳市', '南陵县', '南靖县', '宁乡县', '宁化县', '宁国市', '宁城县', '宁安市', '宁德市', '宁晋县', '宁武县', '宁波市', '宁津县', '宁海县', '宁蒗彝族自治县', '宁远县', '宁都县', '宁阳县', '宁陵县', '尼勒克县', '怒江傈僳族自治州', '楠溪江', '那曲地区']
  },
  {
    key: 'P',
    data: ['偏关县', '凭祥市', '屏东', '屏南县', '屏边苗族自治县', '平乡县', '平凉市', '平利县', '平原县', '平和县', '平安县', '平山县', '平度市', '平江县', '平泉县', '平湖市', '平潭县', '平舆县', '平遥县', '平邑县', '平阳县', '平阴县', '平陆县', '平顶山市', '平顺县', '彭州市', '彭水苗族土家族自治县', '攀枝花市', '普宁市', '普格县', '普洱市', '普者黑景区', '普陀山', '沛县', '浦城县', '浦江县', '澎湖', '濮阳市', '盘县', '盘锦市', '磐安县', '磐石市', '莆田市', '萍乡市', '蒲县', '蒲城县', '蒲江县', '蓬莱市', '邳州市', '郫县', '鄱阳县']
  },
  {
    key: 'Q',
    data: ['七仙岭', '七台河市', '且末县', '丘北县', '乾安县', '伽师县', '全南县', '全椒县', '千岛湖风景区', '启东市', '奇台县', '屈家岭管理区', '巧家县', '庆云县', '庆元县', '庆阳市', '曲周县', '曲沃县', '曲阜市', '曲阳县', '曲靖市', '栖霞市', '沁县', '沁源县', '沁阳市', '泉州市', '淇县', '清丰县', '清徐县', '清河县', '清流县', '清苑县', '清远市', '潜山县', '潜江市', '琼中黎族苗族自治县', '琼海市', '确山县', '祁东县', '祁县', '祁连县', '祁门县', '祁阳县', '秦皇岛市', '綦江区', '蕲春县', '衢州市', '迁安市', '迁西县', '邱县', '钦州市', '青县', '青岛市', '青州市', '青河县', '青海湖', '青田县', '青龙满族自治县', '黔东南苗族侗族自治州', '黔南布依族苗族自治州', '黔江区', '黔西南布依族苗族自治州', '齐河县', '齐齐哈尔市']
  },
  {
    key: 'R',
    data: ['乳山市', '仁寿县', '仁怀市', '任丘市', '任县', '如东县', '如皋市', '容城县', '日喀则地区', '日照市', '汝南县', '汝城县', '汝州市', '汝阳县', '瑞丽市', '瑞安市', '瑞金市', '芮城县', '若尔盖县', '若羌县', '荣成市', '荣昌县', '饶阳县']
  },
  {
    key: 'S',
  ...
  {
    key: 'T',
    data: ['台东', '台中', '台前县', '台北', '台南', '台山市', '台州市', '同里', '吐鲁番地区', '唐县', '唐山市', '唐河县', '团风县', '图们市', '图木舒克市', '塔什库尔干塔吉克自治县', '塔城地区', '天全县', '天台县', '天堂寨镇', '天柱山景区', '天水市', '天津市', '天长市', '天门市', '太仓市', '太原市', '太和县', '太康县', '太谷县', '屯昌县', '屯留县', '托克逊县', '桃园', '桃江县', '桃源县', '桃花岛', '桐乡市', '桐城市', '桐庐县', '桐柏县', '汤阴县', '泰兴市', '泰宁县', '泰安市', '泰州市', '泰顺县', '滕州市', '漯河市', '潼南县', '特克斯县', '腾冲县', '通化市', '通山县', '通州区', '通海县', '通辽市', '通道侗族自治县', '郯城县', '铁岭市', '铜仁市', '铜山区', '铜川市', '铜梁县', '铜陵市']
  },
  {
    key: 'W',
...
var hotCity = ['深圳', '广州', '东莞', '南宁', '柳州', '沈阳', '太原', '大同', '晋城', '成都', '绵阳']
...
$('.searchCity').on('keyup', function () {
  ...
  // }
  if ($('.searchCity').val()) {
    var keyWord = $('.searchCity').val();
    var listData = [];
    $('.allInfo').addClass('thisHide');
    $.each(cityList, function (i, item) {
      $.each(item.data, function (j, data) {
    ...
    $('.searchC').remove();
    $('.allInfo').removeClass('thisHide');
  }
})

function setListData(listData) {
  var listDom = document.getElementById("container");
  for (var i = 0; i < listData.length; i++) {
    var str = `
      <p>` + listData[i] + `</p>
  `;
    var liDom = document.createElement("li");
    liDom.className = 'searchC'
    liDom.innerHTML = str;
